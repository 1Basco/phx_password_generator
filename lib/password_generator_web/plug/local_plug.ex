defmodule PasswordGeneratorWeb.Plugs.Locale do
  import Plug.Conn
  ...
  def call(conn, _opts) do
    ...
    known_locales = Gettext.known_locales(PasswordGeneratorWeb.Gettext)
    ...
    case accepted_languages do
      [locale | _] ->
        Gettext.put_locale(PasswordGeneratorWeb.Gettext, locale)
